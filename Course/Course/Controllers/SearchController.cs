...
namespace Course.Controllers
{
    public class SearchController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchText)
        {
            ...
            List<Tag> tagSearch = await _db.Tags.Where(tag => EF.Functions.FreeText(tag.Name, searchText)).ToListAsync();
            ...
            List<Item> itemSearch = await _db.Items.Where(item => EF.Functions.FreeText(item.Name, searchText)).ToListAsync();
